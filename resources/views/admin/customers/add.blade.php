        ...
        <div class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select required class="form-select form-select-solid dynamic"
                                        data-control="select2" dir="rtl" data-placeholder="اختر المحافظة" required
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{old('website')}}" name="website" class="form-control @error('website') is-invalid @enderror">
                    @error('website')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
