        ...
        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 my-5 mt-lg-2 mb-lg-0"
            ...
            <div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="#>
                                ...
                                <span class="menu-title"> تسعير الاصناف </span>
                            </a>
                        </div>
                ...
                <span class="menu-bullet">
                                ...
                                <span class="menu-title"> عرض أوامر البيع </span>
                            </a>
                        </div>
                ...
                <span class="menu-bullet">
                                ...
                                <span class="menu-title"> إضافة أمر البيع </span>
                            </a>
                        </div>
                ...
                <span class="menu-bullet">
                                ...
                                <span class="menu-title"> عرض فواتير المبيعات </span>
                            </a>
                        </div>
                ...
                <span class="menu-bullet">
                                ...
                                <span class="menu-title"> إضافة فاتورة </span>
                            </a>
                        </div>
                ...
                <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="fw-bold text-muted text-uppercase fs-7">التقارير</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">تقرير بيانات العملاء</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">تقرير الاصناف</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">تقارير المبيعات
                    </a>
                </div>
            </div>
        </div>
